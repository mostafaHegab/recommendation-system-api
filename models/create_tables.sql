...
CREATE TABLE IF NOT EXISTS comments (id BIGINT PRIMARY KEY NOT NULL, text VARCHAR(255) NOT NULL, time DATETIME NOT NULL, pid BIGINT NOT NULL, FOREIGN KEY (pid) REFERENCES products (id), uid BIGINT NOT NULL, FOREIGN KEY (uid) REFERENCES users (id), sentiment_analysis BOOLEAN NOT NULL);
